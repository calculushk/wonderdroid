...
// AKA CVTWL
		...
		OP( 0xa1, i_mov_axdisp) {
			...
			FETCHuint16(addr);
			I.regs.b[AL] = GetMemB(DS0, addr);
			I.regs.b[AH] = GetMemB(DS0, (addr+1)&0xffff);
			CLK(1);
		}
			OP_EPILOGUE;
		...
		OP( 0xa3, i_mov_dispax) {
			...
			FETCHuint16(addr);
			PutMemB(DS0, addr, I.regs.b[AL]);
			PutMemB(DS0, (addr+1)&0xffff, I.regs.b[AH]);
			CLK(1);
		}
			OP_EPILOGUE;
			...
			if (c)
				switch (ModRM & 0x38) {
					case 0x00:
						...
						PutbackRMWord(ModRM, (uint16_t)dst);
						break;
					case 0x08:
						do {
							ROR_uint16;
...
// NEC calls it "PREPARE"
		...
		OP( 0xe0, i_loopne) {
			...
			if (!ZF && I.regs.w[CW]) {
				...
				CLK(3);ADDBRANCHTRACE(I.sregs[PS], I.pc);
		}
			OP_EPILOGUE;
		OP( 0xe1, i_loope) {
			int8_t disp = (int8_t)FETCH;
				...
				case 0xa6:
					...
					if (I.regs.w[CW])
						do {
							...
							I.regs.w[CW]--;
							CLK(3);
							CHK_ICOUNT(I.regs.w[CW] && ZF == 0);
							/* 6 + 3 = 9 */} while (I.regs.w[CW] > 0 && ZF == 0);
					break;
				case 0xa7:
					CLK(5)
					;
				...
				case 0xa6:
					...
					if (I.regs.w[CW])
						do {
							...
							I.regs.w[CW]--;
							CLK(3);
							CHK_ICOUNT(I.regs.w[CW] && ZF == 1);
							/* 6 + 3 = 9 */} while (I.regs.w[CW] > 0 && ZF == 1);
					break;
				case 0xa7:
					CLK(5)
					;
